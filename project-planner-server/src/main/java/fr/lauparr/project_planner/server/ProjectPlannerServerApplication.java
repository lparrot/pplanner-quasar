...
public class ProjectPlannerServerApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Utilisateur user1 = creerUtilisateur("lparrot", "Parrot", "Laurent", "kestodddddddddddddddddddddddddddddddddddunet@gmail.com", LocalDate.of(1983, 9, 3), "06 48 09 11 32", "06 48 09 11 32");
    Utilisateur user2 = creerUtilisateur("aparrot", "Parrot", "Anne", "patesdegeek@gmail.com", LocalDate.of(1982, 7, 13), "01 23 45 67 89", "01 23 45 67 89");
    Utilisateur user3 = creerUtilisateur("ebauduin", "Bauduin", "Edith", "edith.bauduin@gmail.com", LocalDate.of(1960, 3, 17), "98 76 54 32 10", "98 76 54 32 10");
  ...
  private Utilisateur creerUtilisateur(String username, String nom, String prenom, String email, LocalDate dateNaissance, String fixe, String portable) {
